...
def get_dataloaders(dataset_path, batch_size, train_split):
    ...
    train, valid = train_test_split(train, test_size=train_split, random_state=42)
    ...
    valid_loader = torch.utils.data.DataLoader(valid, shuffle=True, batch_size=batch_size)
    return train_loader, valid_loader, test_loader, test